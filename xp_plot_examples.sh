...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot gamma_e1_tailcut_bad.pdf   "$(./utils/search_input_by_score_range.py --worst $INDEX --index 0 score_gamma_mpdspd_tailcut_jd.json         2>/dev/null | awk '{print $1}' | head -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot gamma_e1_tailcut_good.pdf  "$(./utils/search_input_by_score_range.py --best  $INDEX --index 0 score_gamma_mpdspd_tailcut_jd.json         2>/dev/null | awk '{print $1}' | tail -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot gamma_e2_tailcut_bad.pdf   "$(./utils/search_input_by_score_range.py --worst $INDEX --index 1 score_gamma_mpdspd_tailcut_jd.json         2>/dev/null | awk '{print $1}' | head -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot gamma_e2_tailcut_good.pdf  "$(./utils/search_input_by_score_range.py --best  $INDEX --index 1 score_gamma_mpdspd_tailcut_jd.json         2>/dev/null | awk '{print $1}' | tail -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot proton_e1_tailcut_bad.pdf  "$(./utils/search_input_by_score_range.py --worst $INDEX --index 0 score_proton_mpdspd_tailcut_jd.json        2>/dev/null | awk '{print $1}' | head -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot proton_e1_tailcut_good.pdf "$(./utils/search_input_by_score_range.py --best  $INDEX --index 0 score_proton_mpdspd_tailcut_jd.json        2>/dev/null | awk '{print $1}' | tail -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot proton_e2_tailcut_bad.pdf  "$(./utils/search_input_by_score_range.py --worst $INDEX --index 1 score_proton_mpdspd_tailcut_jd.json        2>/dev/null | awk '{print $1}' | head -n 1)"
...
./datapipe/denoising/tailcut_jd.py         -T0.75 -t0.5  --saveplot proton_e2_tailcut_good.pdf "$(./utils/search_input_by_score_range.py --best  $INDEX --index 1 score_proton_mpdspd_tailcut_jd.json        2>/dev/null | awk '{print $1}' | tail -n 1)"
