...
echo "" & echo "* SCORE PROTON MPDSPD I0 BOXPLOT *****" & ./utils/plot_score_boxplot.py   -q               -i0 -o score_proton_mpdspd_i0_boxplot.pdf   score_proton_mpdspd_*.json
echo "" & echo "* SCORE PROTON MPDSPD I1 BOXPLOT *****" & ./utils/plot_score_boxplot.py   -q               -i1 -o score_proton_mpdspd_i1_boxplot.pdf   score_proton_mpdspd_*.json
...
echo "" & echo "* SCORE PROTON MPDSPD I0 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q --logx --logy -i0 -o score_proton_mpdspd_i0_histogram.pdf score_proton_mpdspd_*.json
echo "" & echo "* SCORE PROTON MPDSPD I1 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q --logx --logy -i1 -o score_proton_mpdspd_i1_histogram.pdf score_proton_mpdspd_*.json
...
echo "" & echo "* SCORE GAMMA MPDSPD I0 BOXPLOT ******" & ./utils/plot_score_boxplot.py   -q               -i0 -o score_gamma_mpdspd_i0_boxplot.pdf    score_gamma_mpdspd_*.json
echo "" & echo "* SCORE GAMMA MPDSPD I1 BOXPLOT ******" & ./utils/plot_score_boxplot.py   -q               -i1 -o score_gamma_mpdspd_i1_boxplot.pdf    score_gamma_mpdspd_*.json
...
echo "" & echo "* SCORE GAMMA MPDSPD I0 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q --logx --logy -i0 -o score_gamma_mpdspd_i0_histogram.pdf  score_gamma_mpdspd_*.json
echo "" & echo "* SCORE GAMMA MPDSPD I1 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q --logx --logy -i1 -o score_gamma_mpdspd_i1_histogram.pdf  score_gamma_mpdspd_*.json
