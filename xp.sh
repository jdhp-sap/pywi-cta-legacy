...
echo "" # & echo "* PROTON MPD TAILCUT"     & ./datapipe/denoising/tailcut_jd.py        -b mpd    -T0.75 -t0.5            -o score_proton_mpd_tailcut_jd.json            $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
