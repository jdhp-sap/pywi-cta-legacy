...
echo "" # & echo "* PROTON MPD WAVELETS"    & ./datapipe/denoising/wavelets_mrfilter.py -b mpd                 --saveplot -o score_proton_mpd_wavelets_mrtransform.json     $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
...
echo ""   & echo "* PROTON MPDSDP TAILCUT"  & ./datapipe/denoising/tailcut.py           -b mpdspd -T0.75 -t0.5            -o score_proton_mpdspd_tailcut.json               $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
echo ""   & echo "* PROTON MPDSDP WAVELETS" & ./datapipe/denoising/wavelets_mrfilter.py -b mpdspd                         -o score_proton_mpdspd_wavelets_mrtransform.json  $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo ""   & echo "* PROTON SSPD TAILCUT"    & ./datapipe/denoising/tailcut.py           -b sspd   -T0.75 -t0.5            -o score_proton_sspd_tailcut.json                 $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
echo ""   & echo "* PROTON SSPD WAVELETS"   & ./datapipe/denoising/wavelets_mrfilter.py -b sspd                           -o score_proton_sspd_wavelets_mrtransform.json    $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo "" # & echo "* GAMMA MPD WAVELETS"    & ./datapipe/denoising/wavelets_mrfilter.py -b mpd                 --saveplot -o score_gamma_mpd_wavelets_mrtransform.json      $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo "" # & echo "* GAMMA MPDSDP TAILCUT"  & ./datapipe/denoising/tailcut.py           -b mpdspd -T0.75 -t0.5            -o score_gamma_mpdspd_tailcut.json                $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & echo "* GAMMA MPDSDP WAVELETS" & ./datapipe/denoising/wavelets_mrfilter.py -b mpdspd                         -o score_gamma_mpdspd_wavelets_mrtransform.json   $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo "" # & echo "* GAMMA SSPD TAILCUT"    & ./datapipe/denoising/tailcut.py           -b sspd   -T0.75 -t0.5            -o score_gamma_sspd_tailcut.json                  $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & echo "* GAMMA SSPD WAVELETS"   & ./datapipe/denoising/wavelets_mrfilter.py -b sspd                           -o score_gamma_sspd_wavelets_mrtransform.json     $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo "" # & echo "* GAMMA MPD WAVELETS"    & ./datapipe/denoising/wavelets_mrfilter.py -b mpd                 --saveplot -o score_gamma_mpd_wavelets_mrtransform.json      ~/data/astri_mini_array/fits/gamma
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo ""   & echo "* GAMMA MPDSDP TAILCUT"  & ./datapipe/denoising/tailcut.py           -b mpdspd -T0.75 -t0.5            -o score_gamma_mpdspd_tailcut.json                ~/data/astri_mini_array/fits/gamma
echo ""   & echo "* GAMMA MPDSDP WAVELETS" & ./datapipe/denoising/wavelets_mrfilter.py -b mpdspd                         -o score_gamma_mpdspd_wavelets_mrtransform.json   ~/data/astri_mini_array/fits/gamma
echo "" # & for FILE in *.fits ; do rm $FILE ; done
...
echo ""   & echo "* GAMMA SSPD TAILCUT"    & ./datapipe/denoising/tailcut.py           -b sspd -T0.75 -t0.5              -o score_gamma_sspd_tailcut.json                  ~/data/astri_mini_array/fits/gamma
echo ""   & echo "* GAMMA SSPD WAVELETS"   & ./datapipe/denoising/wavelets_mrfilter.py -b sspd                           -o score_gamma_sspd_wavelets_mrtransform.json     ~/data/astri_mini_array/fits/gamma
echo "" # & for FILE in *.fits ; do rm $FILE ; done
