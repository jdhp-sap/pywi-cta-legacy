...
#echo ""   & echo "* PROTON MPDSDP WAVELETS" & ./datapipe/denoising/wavelets_mrtransform.py -b mpdspd -o score_proton_mpdspd_wavelets_mrtransform.json  $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
#echo ""   & echo "* GAMMA MPDSDP WAVELETS"  & ./datapipe/denoising/wavelets_mrtransform.py -b mpdspd -o score_gamma_mpdspd_wavelets_mrtransform.json   ~/data/astri_mini_array/fits/gamma
...
echo "" # & echo "* PROTON MPD TAILCUT"     & ./datapipe/denoising/tailcut_jd.py        -b mpd    -T10   -t5              -o score_proton_mpd_tailcut_jd.json            $(find ~/data/astri_mini_array/fits/proton -type f -name "*.fits" | head -n ${NUM_IMG})
...
echo "" # & echo "* GAMMA MPD TAILCUT"     & ./datapipe/denoising/tailcut_jd.py        -b mpd    -T10   -t5              -o score_gamma_mpd_tailcut_jd.json             $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
...
echo "" # & echo "* GAMMA MPDSDP TAILCUT"  & ./datapipe/denoising/tailcut_jd.py        -b mpdspd -T10   -t5              -o score_gamma_mpdspd_tailcut_jd.json          $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
...
echo "" # & echo "* GAMMA SSPD TAILCUT"    & ./datapipe/denoising/tailcut_jd.py        -b sspd   -T10   -t5              -o score_gamma_sspd_tailcut_jd.json            $(find ~/data/astri_mini_array/fits/gamma -type f -name "*.fits" | head -n ${NUM_IMG})
...
echo "" # & echo "* GAMMA MPD TAILCUT"     & ./datapipe/denoising/tailcut_jd.py        -b mpd -T10   -t5                 -o score_gamma_mpd_tailcut_jd.json             ~/data/astri_mini_array/fits/gamma
