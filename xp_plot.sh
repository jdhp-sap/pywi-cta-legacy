...
echo ""   & echo "* SCORE PROTON MPDSPD I0 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q        --logy -i0 --title "$\mathcal{E}_1$ (protons)"  -o score_proton_mpdspd_i0_histogram.pdf               score_proton_mpdspd_wavelets_mrfilter.json score_proton_mpdspd_tailcut_jd.json score_proton_mpdspd_fft.json
echo ""   & echo "* SCORE PROTON MPDSPD I1 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q --logx --logy -i1 --title "$\mathcal{E}_2$ (protons)"  -o score_proton_mpdspd_i1_histogram.pdf               score_proton_mpdspd_wavelets_mrfilter.json score_proton_mpdspd_tailcut_jd.json score_proton_mpdspd_fft.json
...
echo ""   & echo "* SCORE PROTON SSPD HISTOGRAM ********" & ./utils/plot_score_histogram.py -q        --logy     --title "Tailcut"                    -o score_proton_sspd_histogram_tailcut_jd.pdf         score_proton_sspd_tailcut_jd.json
...
echo ""   & echo "* SCORE GAMMA MPDSPD I0 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q        --logy -i0 --title "$\mathcal{E}_1$ ($\gamma$)" -o score_gamma_mpdspd_i0_histogram.pdf                score_gamma_mpdspd_wavelets_mrfilter.json score_gamma_mpdspd_tailcut_jd.json score_gamma_mpdspd_fft.json
echo ""   & echo "* SCORE GAMMA MPDSPD I1 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q --logx --logy -i1 --title "$\mathcal{E}_2$ ($\gamma$)" -o score_gamma_mpdspd_i1_histogram.pdf                score_gamma_mpdspd_wavelets_mrfilter.json score_gamma_mpdspd_tailcut_jd.json score_gamma_mpdspd_fft.json
...
echo ""   & echo "* SCORE GAMMA SSPD HISTOGRAM *********" & ./utils/plot_score_histogram.py -q        --logy     --title "Tailcut"                    -o score_gamma_sspd_histogram_tailcut_jd.pdf          score_gamma_sspd_tailcut_jd.json
