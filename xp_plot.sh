...
echo ""   & echo "* SCORE PROTON MPDSPD I0 BOXPLOT *****" & ./utils/plot_score_boxplot.py   -q               -i0 --title "$\mathcal{E}_1$ (protons)"  -o score_proton_mpdspd_i0_boxplot.pdf                 score_proton_mpdspd_tailcut_jd.json score_proton_mpdspd_wavelets_mrtransform.json score_proton_mpdspd_wavelets_mrfilter.json
echo ""   & echo "* SCORE PROTON MPDSPD I1 BOXPLOT *****" & ./utils/plot_score_boxplot.py   -q               -i1 --title "$\mathcal{E}_2$ (protons)"  -o score_proton_mpdspd_i1_boxplot.pdf                 score_proton_mpdspd_tailcut_jd.json score_proton_mpdspd_wavelets_mrtransform.json score_proton_mpdspd_wavelets_mrfilter.json
...
echo ""   & echo "* SCORE PROTON MPDSPD I0 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q        --logy -i0 --title "$\mathcal{E}_1$ (protons)"  -o score_proton_mpdspd_i0_histogram.pdf               score_proton_mpdspd_wavelets_mrfilter.json score_proton_mpdspd_tailcut_jd.json
echo ""   & echo "* SCORE PROTON MPDSPD I1 HISTOGRAM ***" & ./utils/plot_score_histogram.py -q --logx --logy -i1 --title "$\mathcal{E}_2$ (protons)"  -o score_proton_mpdspd_i1_histogram.pdf               score_proton_mpdspd_wavelets_mrfilter.json score_proton_mpdspd_tailcut_jd.json
...
echo ""   & echo "* SCORE GAMMA MPDSPD I0 BOXPLOT ******" & ./utils/plot_score_boxplot.py   -q               -i0 --title "$\mathcal{E}_1$ ($\gamma$)" -o score_gamma_mpdspd_i0_boxplot.pdf                  score_gamma_mpdspd_tailcut_jd.json score_gamma_mpdspd_wavelets_mrtransform.json score_gamma_mpdspd_wavelets_mrfilter.json
echo ""   & echo "* SCORE GAMMA MPDSPD I1 BOXPLOT ******" & ./utils/plot_score_boxplot.py   -q               -i1 --title "$\mathcal{E}_2$ ($\gamma$)" -o score_gamma_mpdspd_i1_boxplot.pdf                  score_gamma_mpdspd_tailcut_jd.json score_gamma_mpdspd_wavelets_mrtransform.json score_gamma_mpdspd_wavelets_mrfilter.json
...
echo ""   & echo "* SCORE GAMMA MPDSPD I0 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q        --logy -i0 --title "$\mathcal{E}_1$ ($\gamma$)" -o score_gamma_mpdspd_i0_histogram.pdf                score_gamma_mpdspd_wavelets_mrfilter.json score_gamma_mpdspd_tailcut_jd.json
echo ""   & echo "* SCORE GAMMA MPDSPD I1 HISTOGRAM ****" & ./utils/plot_score_histogram.py -q --logx --logy -i1 --title "$\mathcal{E}_2$ ($\gamma$)" -o score_gamma_mpdspd_i1_histogram.pdf                score_gamma_mpdspd_wavelets_mrfilter.json score_gamma_mpdspd_tailcut_jd.json
...
./utils/plot_image_metadata_histogram.py --key "npe" --logx --logy --exclude-aborted --title "$\sum_i s^*_i$ (protons)"  -q -o score_proton_npe.pdf  score_proton_mpdspd_tailcut_jd.json
